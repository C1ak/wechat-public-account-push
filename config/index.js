export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx8b7aea9f97c4afa9",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "bfaf7d733e44fb5025afb3f9dbd013a7",
  ...
  USERS: [
    {
      ...
      id: "oBlD86t070DavwUnUH1qnUPQl7fc",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "",
      // 所在省份
      province: "山东",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2002", "date": "09-22"},
  ...
  CALLBACK_TEMPLATE_ID: "iZaxT-TOWsTdsEMs_N-o6UEj52ZFQOc8qU1VjouYzR4",
